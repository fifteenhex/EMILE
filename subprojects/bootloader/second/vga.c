...
static unsigned char translation[][256] = {
	/* VT100 Graphics to IBM CP-437 0 */
	{
		...
		,
	},
	/* UK ASCII to IBM CP-437 A */
	{
		...
		0x8c, 0x8d, 0x8e, 0x8f, 0x90, 0x91, 0x92, 0x93, 0x94, 0x95,
		0x96, 0x97, 0x98, 0x99, 0x9a, 0x9b, 0x9c, 0x9d, 0x9e, 0x9f,
		0x5f, 0xa1, 0x9b, 0x7d, 0xa4, 0x9d, 0xa6, 0x15, 0xa8, 0xa9,
		0xa6, 0xab, 0xaa, 0xad, 0xae, 0xaf, 0x66, 0x67, 0xb2, 0xb3,
		0xb4, 0xb5, 0x14, 0x7e, 0xb8, 0xb9, 0xa7, 0xaf, 0xac, 0xab,
		0xbe, 0xa8, 0xc0, 0xc1, 0xc2, 0xc3, 0x8e, 0x8f, 0x92, 0x80,
		0xc8, 0x90, 0xca, 0xcb, 0xcc, 0xcd, 0xce, 0xcf, 0xd0, 0xa5,
		0xd2, 0xd3, 0xd4, 0xd5, 0x99, 0xd7, 0xd8, 0xd9, 0xda, 0xdb,
		0x9a, 0xdd, 0xde, 0xdf, 0x85, 0xa0, 0x83, 0xe3, 0x84, 0x86,
...
int vga_init(const char *mode)
{
	...
	vga.base = vga.video + pm->bounds.top * vga.row_bytes +
		   pm->bounds.left * (vga.depth >> 3);
		...
		case '[':
			...
			case 'm': /* set video mode */
				if (strcmp("[7m", vga.escape_stack) == 0) {
					...
					goto exit_escape;
				} else if (strcmp("[27m", vga.escape_stack) ==
					   0) {
					/* normal */
			...
			case 'n': /* get cursor position */
				if (strcmp("[6n", vga.escape_stack) == 0) {
					...
					sprintf(buf, "\033[%ld;%ldR",
						vga.pos_y + 1, vga.pos_x + 1);
					keyboard_inject(buf);
					goto exit_escape;
				}
				break;
